...
const OBJECT_UNIQ_STORED_NAME: &str =
    "org.astarte-platform.rust.examples.individual-datastream.StoredUniqDeviceDatastream";
...
const OBJECT_UNIQ_VOLATILE_NAME: &str =
    "org.astarte-platform.rust.examples.individual-datastream.VolatileUniqDeviceDatastream";
