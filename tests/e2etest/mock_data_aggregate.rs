...
pub struct TestAggregateData {
    ...
    // Requires: chrono feature serde
    // datetime_endpoint: chrono::DateTime<chrono::Utc>,
    datetime_endpoint: bson::DateTime,
    ...
    datetimearray_endpoint: Vec<bson::DateTime>,
}
...
impl MockDataAggregate {
    ...
    pub fn init() -> Self {
        let device_to_server = TestAggregateData {
            ...
            datetime_endpoint: chrono::offset::Utc::now().into(),
        ...
        let server_to_device = utils::initialize_hash_map(
            ...
            // )),
            None,
            // TODO workaround for bug in Astarte:
            // Some((
            ...
            match key.as_str() {
                ...
                "datetimearray_endpoint" => {
                    data.datetimearray_endpoint = value
                        ...
                        .collect::<Result<Vec<bson::DateTime>, String>>()?;
                }
                _ => {
