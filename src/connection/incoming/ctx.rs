...
mod tests {
    ...
    use crate::test::{
        E2E_DEVICE_DATASTREAM, E2E_DEVICE_DATASTREAM_NAME, E2E_SERVER_AGGREGATE,
        E2E_SERVER_AGGREGATE_NAME, E2E_SERVER_DATASTREAM, E2E_SERVER_DATASTREAM_NAME,
        E2E_SERVER_PROPERTY, E2E_SERVER_PROPERTY_NAME, SERVER_OBJECT, SERVER_OBJECT_NAME,
        SERVER_PROPERTIES_NO_UNSET, SERVER_PROPERTIES_NO_UNSET_NAME,
    };
    ...
    #[tokio::test]
    async fn partial_obj() {
        let (this, client_rx) = mock_receiver_task(
            MockStore::new(),
            &[E2E_SERVER_AGGREGATE],
            ConnStatus::Online,
        );

        let obj = AstarteObject::from_iter(
            [
                ("double_endpoint", AstarteData::try_from(42.1).unwrap()),
                ("string_endpoint", AstarteData::String("value".to_string())),
                (
        ...
        let exp_interface = E2E_SERVER_AGGREGATE_NAME;
        let endpoint = "/sensor1";
