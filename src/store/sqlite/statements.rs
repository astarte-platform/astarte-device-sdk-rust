...
impl WriteConnection {
    ...
    pub(super) fn store_prop(
        ...
        let mut statement = self
            ...
            .wrap_err_ctx(SqliteError::Prepare, "while storing property")?;
        ...
        statement
            ...
            .wrap_err_ctx(SqliteError::Query, "while storing property")?;
    ...
    pub(super) fn update_state(
        ...
        let transaction = self
            .transaction()
            .wrap_err_ctx(SqliteError::Transaction, "while updating state")?;
        ...
        let result = {
            ...
            let mut statement = transaction
                ...
                .wrap_err_ctx(SqliteError::Prepare, "while updating state")?;

            let result = statement
                .execute((RecordPropertyState::from(state), interface, path))
                .wrap_err_ctx(SqliteError::Query, "while updating state")?;
...
fn query_prop_row(
    ...
    let mut statement = connection
        ...
        .wrap_err_ctx(SqliteError::Prepare, "while querying property")?;
...
impl ReadConnection {
    ...
    pub(super) fn props_with_unset(
        ...
        let limit = i64::try_from(limit)
            .wrap_err_with(|_| Error::new(SqliteError::Conversion).set_message(limit))?;
        let offset = i64::try_from(offset)
            .wrap_err_with(|_| Error::new(SqliteError::Conversion).set_message(offset))?;
