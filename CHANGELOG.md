...
- Update `syn` to fix transitive dependency which fails to compile while generating the doc on
  docs.rs [#382](https://github.com/astarte-platform/astarte-device-sdk-rust/pull/382)
